        ...
        <form action="<?=$action?>" class="personal__form form">
            ...
            <div class="form__items">
                <div class="form__item">
                    ...
                    <div class="form__box">
                        <input readonly="readonly" name="name" type="text" class="form__input" value="Константинопольский Константин Константинович" placeholder="Фамилия Имя Отчество">
                ...
                <div class="form__item">
                    ...
                    <div class="form__box">
                        <input name="phone" type="phone" class="form__input" placeholder="Телефон" data-inputmask="'mask': '+7 ### ###-##-##'" value="+7 987 452-31-47">
                ...
                <div class="form__item pass">
                    ...
                    <div class="form__box">
                        <input name="password" type="password" class="form__input" placeholder="Введите новый пароль">
                ...
                <div class="form__item pass">
                    ...
                    <input name="password" type="password" class="form__input" placeholder="Повторите новый пароль">
                </div>
            </div>

            <button class="form__button">Сохранить изменения</button>
            </div>
        </form>
...
<div class="orders" id="orders">
    ...
    <div class="orders__items">
        ...
        <div class="orders__item  ">
            ...
            <div class="orders__item-box">
                <div class="orders__item-top">
                    <div class="orders__item-order">Заказ №2130 от 05.10.2022</div>
                    <div class="orders__item-price">550 ₽</div>
                </div>
                <div class="orders__item-name">Трансфер спортсмена - источник дохода в индустрии спорта</div>
                <div class="orders__item-bottom">
                    <div class="orders__item-type">Тип: мягкая обложка</div>
                    <div class="orders__item-count">Кол-во: 1</div>
                    <div class="orders__item-status not-sent">Ожидает отправки</div>
                </div>
            </div>
        </div>
        ...
        <div class="orders__item  ">
            ...
            <div class="orders__item-box">
                <div class="orders__item-top">
                    <div class="orders__item-order">Заказ №2129 от 27.09.2022</div>
                    <div class="orders__item-price">640 ₽</div>
                </div>
                <div class="orders__item-name">Теория менеджмента. Учебник. 4-е изд. стер. 2019 г.</div>
                <div class="orders__item-bottom">
                    <div class="orders__item-type">Тип: твердая обложка</div>
                    <div class="orders__item-count">Кол-во: 10</div>
                    <div class="orders__item-status sent">Отправлено</div>
                </div>
            </div>
        </div>
        ...
        <div class="orders__item  ">
            ...
            <div class="orders__item-box">
                <div class="orders__item-top">
                    <div class="orders__item-order">Заказ №2128 от 14.09.2022</div>
                    <div class="orders__item-price">750 ₽</div>
                </div>
                <div class="orders__item-name">Управление человеческими ресурсами организации. 5-е изд. стер. 2019 г.</div>
                <div class="orders__item-bottom">
                    <div class="orders__item-type">Тип: мягкая обложка</div>
                    <div class="orders__item-count">Кол-во: 100</div>
                    <div class="orders__item-status wait">Ожидает в пункте выдачи</div>
                </div>
            </div>
        </div>
        ...
        <div class="orders__item  ">
            ...
            <div class="orders__item-box">
                <div class="orders__item-top">
                    <div class="orders__item-order">Заказ №2127 от 03.09.2022</div>
                    <div class="orders__item-price">1050 ₽</div>
                </div>
                <div class="orders__item-name">СМ: все о спортивном менеджменте и маркетинге, альманах, выпуск 4. 2021 г.</div>
                <div class="orders__item-bottom">
                    <div class="orders__item-type">Тип: твердая обложка</div>
                    <div class="orders__item-count">Кол-во: 1000</div>
                    <div class="orders__item-status received">Получено</div>
                </div>
            </div>
        </div>
        
        <div class="orders__item   hidden ">
            <img src="img/orders/1.jpg" alt="">
            <div class="orders__item-box">
                <div class="orders__item-top">
                    <div class="orders__item-order">Заказ №2130 от 05.10.2022</div>
...
<div class="popup-menu" id="popup-menu">
   <div class="popup-menu__list"> <!-- UPH-7 -->
        ...
        <a href="#about" class="popup-menu__link scroll">нас</a> <!-- UPH-7 -->
        <a href="#info" class="popup-menu__link scroll">Информация для авторов</a> <!-- UPH-7 -->
        <a href="/" class="popup-menu__link">Личный кабинет</a>
